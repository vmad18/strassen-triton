...
import torch
from strassen import run_strassen_2_layer_fp32_accum, run_winograd_strassen, run_matmul_fp32_accum
...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        x_log=True,
        line_arg='provider',
        line_vals=['strassen2', 'strassen', 'triton'],
        line_names=['Strassen(depth=2)', 'Strassen(depth=1)', 'Triton'],
...
if __name__ == '__main__':
    # benchmark_matrix_size.run(show_plots=True, print_data=True)
